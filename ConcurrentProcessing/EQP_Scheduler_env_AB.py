...
import numpy as np
import EQP_Scheduler_AB as scd
import logging
import random

# Register this module as a gym environment. Once registered, the id is usable in gym.make().
register(
    id='eqp-scheduler-v0_AB_3_FP',                                      # call it whatever you want
    entry_point='EQP_Scheduler_env_AB:EQP_Scheduler_Env_AB_3_FP',       # module_name:class_name
)
...
VAC_ATM_CHANGE_TIME = 30
CMD_CLEANING_LIMIT = 20
CMD_CLEANING_TIME = 3
ATR_EXECUTION_TIME = 5
ALIENER_EXECUTION_TIME = 1
LP_IN_OUT_PROCESS_TIME = 1

class EQP_Scheduler_Env_AB_3_FP(gym.Env):
